    ...
    public class ToolTipController : MonoBehaviour {
        ...
        private void Update() {
            ...
            if (toolTipToDisplay) {
                ...
                var (width, height) = toolTipToDisplay.CalculateSize(text, (margin.x, margin.y, margin.z, margin.w));
                ...
                var position = Input.mousePosition +
                    (screenPosition.x < Camera.main.pixelWidth / 2 ? Vector3.right : Vector3.left) * 10 +
                    (screenPosition.y < Camera.main.pixelHeight / 2 ? Vector3.up : Vector3.down) * 10;
                ...
                backgroundImage.rectTransform.SetPositionAndRotation(position, Quaternion.identity);
